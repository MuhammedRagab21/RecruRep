...
const THEMES: Record<ThemeVariant, { accent: string; accentHover: string; bgFrom: string; bgTo: string }> = {
  v1: { accent: "#C9A84C", accentHover: "#d4b85a", bgFrom: "#13294B", bgTo: "#0d1f3a" },
  v2: { accent: "#D4836D", accentHover: "#c4735d", bgFrom: "#1A6566", bgTo: "#0f4041" },
  v3: { accent: "#E8A838", accentHover: "#d99a2e", bgFrom: "#3B4A6B", bgTo: "#2a354f" },
  v4: { accent: "#7A9E7E", accentHover: "#6a8e6e", bgFrom: "#1B2A4A", bgTo: "#101f38" },
}

export function WaitlistExperience({ theme = "v1" }: WaitlistExperienceProps): ReactElement {
  const mountRef = useRef<HTMLDivElement>(null)
  const [email, setEmail] = useState("")
  const [isSubmitted, setIsSubmitted] = useState(false)
  const [timeLeft, setTimeLeft] = useState({ days: 225, hours: 23, minutes: 17, seconds: 58 })
      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="flex items-center justify-center min-h-screen px-4">
          <div className="relative">
            <div
              className="relative backdrop-blur-xl bg-black/60 border border-white/20 rounded-3xl p-8 w-[420px] shadow-2xl"
            >
                  ...
                  <>
                    <div className="mb-8 text-center">
                      ...
                      <p className="text-white/70 text-base leading-relaxed">
                        Get early access to Curric — the AI-powered
                        <br />
                        teaching job platform launching soon
                      </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="mb-6">
                      <div className="flex gap-3">
                        ...
                        <Button
                          type="submit"
                          className="h-12 px-6 font-medium rounded-xl transition-all duration-300"
                          style={{
                    ...
                    <div className="flex items-center justify-center gap-3 mb-6">
                      <div className="flex -space-x-2">
                        ...
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-green-400 to-green-600 border-2 border-white/20 flex items-center justify-center text-white text-xs font-medium">A</div>
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-400 to-purple-600 border-2 border-white/20 flex items-center justify-center text-white text-xs font-medium">M</div>
                      </div>
